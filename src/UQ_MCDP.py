...
def McUQ(UQalgo, dataset, model_type, model_num, save_dir):
    ...
    for rs, dp_rate in product(random_seed, dp_rate_list):
        ...
        model_map = {
            'MLP': {'model': model_zoo.MLPMcModel, 'rate': 1},
            'CNN': {'model': model_zoo.CNNMcModel, 'rate': 1},
        }
...
if __name__ == "__main__":
    ...
    for dataset in dataset_list:  
        McUQ(UQalgo='MCDP', dataset=dataset, model_type='MLP', model_num=5, save_dir='./result')